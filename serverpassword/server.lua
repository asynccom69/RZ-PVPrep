...
--- CONFIG ---
password = "MaitenanceMdp" -- Set server password here
kickMessage = "Maitenance" -- The invalid password kick message. Default: Invalid Password
timeRanOutMsg = "Maitenance" --Not active yet! Dont worry about this
timeoutMessage = "Maitenance" -- Displayed if the user tries to attempt too many times, this locks them out of the server for x seconds
